...
\addtocategory{libri}{tanenbaum:reti}
\addtocategory{web}{site:w3cxmlschame}
\addtocategory{web}{site:w3cxml}
\addtocategory{web}{site:w3csvg}
\addtocategory{web}{site:isoodf}
