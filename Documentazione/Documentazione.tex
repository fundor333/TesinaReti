...
XML si prefigge di essere una versione semplificata di Standard Generalized Markup Language (conosciuto anche come SGML o ISO 8879) da cui deriva.
...
\section{DTD}
Il DTD permette di descrivere i tag html da utilizzare all'interno di un documento e il loro rapporto reciproco. Questo permette un ampio controllo sul contenuto del documento e semplifica il lavoro di elaborazione di entrambi le parti. 

Infatti se si concordano in anticipo i DTD da utilizzare nella trasmissione dei dati si ottiene un documento XML 
